...
// Cross Module References
	SHOOTER_API UEnum* Z_Construct_UEnum_Shooter_EItemType();
...
// End Cross Module References
	static UEnum* EItemType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Shooter_EItemType, Z_Construct_UPackage__Script_Shooter(), TEXT("EItemType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EItemType(EItemType_StaticEnum, TEXT("/Script/Shooter"), TEXT("EItemType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Shooter_EItemType_Hash() { return 144402240U; }
	UEnum* Z_Construct_UEnum_Shooter_EItemType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Shooter();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EItemType"), 0, Get_Z_Construct_UEnum_Shooter_EItemType_Hash(), false);
#else
...
static struct FScriptStruct_Shooter_StaticRegisterNativesFItemRarityTable
{
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PlusDamage_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_PlusDamage;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FItemRarityTable_Statics::NewProp_PlusDamage_MetaData[] = {
		{ "Category", "ItemRarityTable" },
		{ "ModuleRelativePath", "Item.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FItemRarityTable_Statics::NewProp_PlusDamage = { "PlusDamage", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FItemRarityTable, PlusDamage), METADATA_PARAMS(Z_Construct_UScriptStruct_FItemRarityTable_Statics::NewProp_PlusDamage_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FItemRarityTable_Statics::NewProp_PlusDamage_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FItemRarityTable_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FItemRarityTable_Statics::NewProp_PlusDamage,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FItemRarityTable_Hash() { return 490313648U; }
	...
	struct Z_Construct_UClass_AItem_Statics
	{
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AmmoItem_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_AmmoItem;
#if WITH_METADATA
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_IconBackground;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_RarPlusDamage_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_RarPlusDamage;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AItem_Statics::NewProp_ItemType = { "ItemType", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AItem, ItemType), Z_Construct_UEnum_Shooter_EItemType, METADATA_PARAMS(Z_Construct_UClass_AItem_Statics::NewProp_ItemType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AItem_Statics::NewProp_ItemType_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_MaterialIndex_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "ItemProperties" },
		{ "Comment", "//Index for the material We'd like to change at runtime\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Index for the material We'd like to change at runtime" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_MaterialInstance_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "ItemProperties" },
		{ "Comment", "//material inscance used with the Dynamic Material Instance\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "material inscance used with the Dynamic Material Instance" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_PulseCurve_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "ItemProperties" },
		{ "Comment", "//Curve to drive the dynamic material parameters \n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Curve to drive the dynamic material parameters" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_IconItem_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Inventory" },
		{ "Comment", "//Icon for this itme in the inventory\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Icon for this itme in the inventory" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_AmmoItem_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Inventory" },
		{ "Comment", "//Ammo Icon for this itme in the inventory\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Ammo Icon for this itme in the inventory" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AItem_Statics::NewProp_AmmoItem = { "AmmoItem", nullptr, (EPropertyFlags)0x0040000000000015, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AItem, AmmoItem), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AItem_Statics::NewProp_AmmoItem_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AItem_Statics::NewProp_AmmoItem_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_SlotIndex_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Inventory" },
		{ "Comment", "//Slot in the inventory array\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Slot in the inventory array" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_bCharacterInventoryFull_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Inventory" },
		{ "Comment", "// True when the character's inventory is full\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "True when the character's inventory is full" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_LightColor_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Rarity" },
		{ "Comment", "//Light Color in the PickupWidget\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Light Color in the PickupWidget" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_DarkColor_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Rarity" },
		{ "Comment", "//Dark Color in the PickupWidget\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Dark Color in the PickupWidget" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_NumberOfStars_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Rarity" },
		{ "Comment", "//Number of the stars in the pickup widget\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Number of the stars in the pickup widget" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_IconBackground_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Rarity" },
		{ "Comment", "//Background icon for the inventory\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "Background icon for the inventory" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_RarPlusDamage_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "WeaponProperties" },
		{ "ModuleRelativePath", "Item.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AItem_Statics::NewProp_RarPlusDamage = { "RarPlusDamage", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AItem, RarPlusDamage), METADATA_PARAMS(Z_Construct_UClass_AItem_Statics::NewProp_RarPlusDamage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AItem_Statics::NewProp_RarPlusDamage_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AItem_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AItem_Statics::NewProp_RarPlusDamage,
	};
	...
	IMPLEMENT_CLASS(AItem, 4033347397);
