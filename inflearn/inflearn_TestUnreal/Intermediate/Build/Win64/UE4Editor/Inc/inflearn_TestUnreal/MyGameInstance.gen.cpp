...
#include "inflearn_TestUnreal/MyGameInstance.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	INFLEARN_TESTUNREAL_API UScriptStruct* Z_Construct_UScriptStruct_FMyCharacterData();
	UPackage* Z_Construct_UPackage__Script_inflearn_TestUnreal();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FTableRowBase();
	INFLEARN_TESTUNREAL_API UClass* Z_Construct_UClass_UMyGameInstance_NoRegister();
	INFLEARN_TESTUNREAL_API UClass* Z_Construct_UClass_UMyGameInstance();
...
class UScriptStruct* FMyCharacterData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern INFLEARN_TESTUNREAL_API uint32 Get_Z_Construct_UScriptStruct_FMyCharacterData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMyCharacterData, Z_Construct_UPackage__Script_inflearn_TestUnreal(), TEXT("MyCharacterData"), sizeof(FMyCharacterData), Get_Z_Construct_UScriptStruct_FMyCharacterData_Hash());
	}
	return Singleton;
}
template<> INFLEARN_TESTUNREAL_API UScriptStruct* StaticStruct<FMyCharacterData>()
{
	return FMyCharacterData::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FMyCharacterData(FMyCharacterData::StaticStruct, TEXT("/Script/inflearn_TestUnreal"), TEXT("MyCharacterData"), false, nullptr, nullptr);
static struct FScriptStruct_inflearn_TestUnreal_StaticRegisterNativesFMyCharacterData
{
	FScriptStruct_inflearn_TestUnreal_StaticRegisterNativesFMyCharacterData()
	{
		UScriptStruct::DeferCppStructOps<FMyCharacterData>(FName(TEXT("MyCharacterData")));
	}
} ScriptStruct_inflearn_TestUnreal_StaticRegisterNativesFMyCharacterData;
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMyCharacterData()
	{
		...
		UPackage* Outer = Z_Construct_UPackage__Script_inflearn_TestUnreal();
	...
	uint32 Get_Z_Construct_UScriptStruct_FMyCharacterData_Hash() { return 2568575872U; }
	...
	IMPLEMENT_CLASS(UMyGameInstance, 521463146);
	template<> INFLEARN_TESTUNREAL_API UClass* StaticClass<UMyGameInstance>()
	{
		return UMyGameInstance::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMyGameInstance(Z_Construct_UClass_UMyGameInstance, &UMyGameInstance::StaticClass, TEXT("/Script/inflearn_TestUnreal"), TEXT("UMyGameInstance"), false, nullptr, nullptr, nullptr);
