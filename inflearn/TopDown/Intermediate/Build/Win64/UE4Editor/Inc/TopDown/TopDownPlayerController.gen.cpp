...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATopDownPlayerController_Statics::Class_MetaDataParams[] = {
		{ "HideCategories", "Collision Rendering Utilities|Transformation" },
		{ "IncludePath", "TopDownPlayerController.h" },
		{ "ModuleRelativePath", "TopDownPlayerController.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ATopDownPlayerController_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_ATopDownPlayerController()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ATopDownPlayerController_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ATopDownPlayerController, 3714879486);
	template<> TOPDOWN_API UClass* StaticClass<ATopDownPlayerController>()
	{
		return ATopDownPlayerController::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ATopDownPlayerController(Z_Construct_UClass_ATopDownPlayerController, &ATopDownPlayerController::StaticClass, TEXT("/Script/TopDown"), TEXT("ATopDownPlayerController"), false, nullptr, nullptr, nullptr);
